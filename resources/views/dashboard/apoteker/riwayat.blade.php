...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-4 mb-6 md:grid-cols-3">
        <div class="card">
            <div class="text-pink-600 bg-pink-100 icon">
        ...
        <div class="card">
            <div class="text-teal-600 bg-teal-100 icon">
        ...
        <div class="card">
            <div class="text-orange-600 bg-orange-100 icon">
    ...
    <div class="flex items-center justify-between mb-4">
        <div>
            ...
            <span class="ml-2 text-sm text-gray-500">entries</span>
        </div>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="text-center">
                            <button onclick='openDetail(@json($r))'
                                class="text-teal-600 bg-teal-100 icon-btn">
    ...
    {{-- ================= MODAL DETAIL ================= --}}
    <div id="detailModal" class="fixed inset-0 z-50 items-center justify-center hidden bg-black/40">
        ...
        <div class="w-[520px] bg-white rounded-xl p-6">
            ...
            <div class="space-y-3 text-sm">
                ...
                <div>
                    <p class="mb-2 label">Obat Keluar</p>
