...
@section('content')
    ...
    <div class="space-y-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a href="{{ route('dashboard.manajer.layanan.create') }}"
                        ...
                        @forelse ($layanan as $item)
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 space-x-2 text-center">
                                    ...
                                    {{-- VIEW --}}
                                    <a href="{{ route('dashboard.manajer.layanan.show', $item->id) }}"
                                    ...
                                    {{-- EDIT --}}
                                    <a href="{{ route('dashboard.manajer.layanan.edit', $item->id) }}"
                                        class="p-2 text-white bg-orange-500 rounded-lg hover:bg-orange-600" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    {{-- DELETE --}}
                                    <form action="{{ route('dashboard.manajer.layanan.destroy', $item->id) }}"
